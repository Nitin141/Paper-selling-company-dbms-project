...
if (localStorage.getItem('role') === 'A') {
  ...
  btn1.addEventListener('click', (e) => {
    window.location.href = '/public/table/clienttable.html'
  })
  btn2.addEventListener('click', (e) => {
    window.location.href = '/public/table/clienttable1.html'
  })
  btn3.addEventListener('click', (e) => {
    window.location.href = '/public/insertclient.html'
  })
  btn4.addEventListener('click', (e) => {
    window.location.href = '/public/deleteclient.html'
  })
  btn5.addEventListener('click', (e) => {
    window.location.href = '/public/netsales.html'
  })
} else if (role2 === 'E') {
  console.log('hello')
  let div = document.getElementById('displayclient')
